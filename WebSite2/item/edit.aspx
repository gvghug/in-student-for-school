<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit.aspx.cs" Inherits="item_edit" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
<title>收支项目管理--编辑</title>
  ...
  <tr>
    <td height="215" valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0">
      <tr align="left" class="bg03">
        <td width="100%" height="29"><span class="text001">&nbsp;&nbsp;修改收支分类</span></td>
      </tr>
    </table>
      <table width="98%" border="0" cellpadding="0" cellspacing="0" class="text008">
        ...
        <tr align="center">
          ...
          <td width="88%" align="left"><asp:TextBox ID="txtSortOrder" runat="server" CssClass="inp001"></asp:TextBox></td>
        </tr>
      </table>
