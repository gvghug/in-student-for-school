...
public partial class item_list : System.Web.UI.Page
{
    ...
    protected void btn_delete_Click(object sender, ImageClickEventArgs e)
    {
        foreach (GridViewRow row in GridView1.Rows)
        {
            ...
            if (chk_item != null && chk_item.Checked)
            {
                ...
                SqlDataSource1.DeleteParameters["itemId"].DefaultValue = keyId.ToString();
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("edit.aspx?itemId=" + itemId);
        }
        else if (e.CommandName == "Delete")
        {
            SqlDataSource1.DeleteParameters["itemId"].DefaultValue = itemId.ToString();
            SqlDataSource1.Delete();
            GridView1.DataBind();
        }
    }
